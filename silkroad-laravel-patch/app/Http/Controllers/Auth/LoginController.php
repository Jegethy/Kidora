...
class LoginController extends Controller
{
    ...
    */
    ...
    protected function validateLogin(Request $request)
    {
        ...
        if ($this->isEmail($request->get('login'))) {
            $array[] = 'email';
        }
    ...
    public function login(Request $request)
    {
        ...
        $user = User::where($this->username($request->get('login')), $request->get('login'))->first();
    ...
    public function username($login = null)
    {
        ...
        return $this->isEmail($login) ? 'email' : 'silkroad_id';
    }
     ...
     */
    private function isEmail(string $login)
    {
